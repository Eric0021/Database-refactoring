...
set CLASSPATH=%APP_HOME%\lib\Final-1.0-SNAPSHOT.jar

@rem Execute Final
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FINAL_OPTS%  -classpath "%CLASSPATH%" au.edu.sydney.cpa.erp.view.CLI %CMD_LINE_ARGS%
